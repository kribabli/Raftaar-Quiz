...
public class SetQuestionActivity extends AppCompatActivity {
    ...
    String setQuestionsUrl = "http://adminapp.tech/raftarquiz/userapi/setque.php";
    String category_id;
    ...
    private void getAllQuestionsList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, setQuestionsUrl, response -> {
            try {
    ...
    private void showCustomDialog() {
        final Dialog dialog = new Dialog(SetQuestionActivity.this);
