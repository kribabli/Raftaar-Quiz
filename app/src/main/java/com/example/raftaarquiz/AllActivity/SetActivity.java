...
public class SetActivity extends AppCompatActivity {
    ...
    String setUrl = "https://adminapp.tech/raftarquiz/userapi/testseries.php";
    ...
    private void getAllTestSeriesList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, setUrl, response -> {
            try {
                listItems.clear();
    ...
    //SetAdapter for CategoryList
    public class SetAdapter extends RecyclerView.Adapter<SetAdapter.ViewHolder> {
        public List<QuizCategories> list;
        public Context context;

        public SetAdapter(ArrayList<QuizCategories> list) {
            this.list = list;
        }
